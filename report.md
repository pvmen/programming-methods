...
Измерялось только получение чисел из генератора, без записи значений в файл и без сохранения всей выборки в массив.
...
Скорость генераторов сравнивалась через время генерации: чем меньше время на одном и том же количестве чисел, тем быстрее генератор.
По этому показателю самым быстрым в большинстве крупных замеров оказался `mixed_lcg`.
