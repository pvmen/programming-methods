...
Сортировка пузырьком и шейкер-сортировка имеют квадратичную сложность в общем случае, но в этой работе для набора до 110000 элементов используются почти отсортированные данные. На таких данных обе простые сортировки завершаются быстро благодаря раннему выходу после прохода без обменов.
